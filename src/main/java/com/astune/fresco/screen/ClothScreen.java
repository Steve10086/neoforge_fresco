...
public class ClothScreen extends Screen {
    ...
    public ClothScreen(ItemStack clothStack, int slot) {
        super(Component.translatable("fresco.cloth_screen.title"));
    ...
    protected void init() {
        ...
        addRenderableWidget(new TexturedSlider(cx - WIDGET_W / 2, y, WIDGET_W, WIDGET_H,
                Component.translatable("fresco.cloth_screen.size"),
        ...
        addRenderableWidget(new TexturedSlider(cx - WIDGET_W / 2, y, WIDGET_W, WIDGET_H,
                Component.translatable("fresco.cloth_screen.opacity"),
                opacity,
        ...
        addRenderableWidget(new TexturedSlider(cx - WIDGET_W / 2, y, WIDGET_W, WIDGET_H,
                Component.translatable("fresco.cloth_screen.feather"),
                feather,
        ...
        addRenderableWidget(new TexturedButton(cx - WIDGET_W / 2, y, WIDGET_W, WIDGET_H,
                Component.translatable("fresco.cloth_screen.clean"),
                btn -> {
                    save();
                    clothStack.remove(Fresco.CLOTH_TINT.get());
                    clothStack.remove(Fresco.CLOTH_SATURATION.get());
                    clothStack.set(Fresco.CLOTH_TINT.get(), 0xFFFFFFFF);
                    clothStack.set(Fresco.CLOTH_SATURATION.get(), 0);
                    sync();
                    if (minecraft != null && minecraft.player != null) {
                        minecraft.player.displayClientMessage(
                                Component.translatable("item.fresco.cloth.reset"), true);
                    }
                }));
        y += 40;
