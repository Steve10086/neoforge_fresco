...
public class TexturedButton extends AbstractButton {
    ...
    private static final WidgetSprites SPRITES = new WidgetSprites(
            ResourceLocation.fromNamespaceAndPath(Fresco.MODID, "widget/button"),
            ResourceLocation.fromNamespaceAndPath(Fresco.MODID, "widget/button_disabled"),
            ResourceLocation.fromNamespaceAndPath(Fresco.MODID, "widget/button_highlighted")
    );
